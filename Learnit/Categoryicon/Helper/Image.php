...
namespace Learnit\Categoryicon\Helper;
...
class Image extends \Magento\Framework\App\Helper\AbstractHelper {
    ...
    \Magento\Framework\App\Helper\Context $context, \Magento\Framework\Filesystem $filesystem, \Magento\Framework\Image\AdapterFactory $imageFactory, \Magento\Store\Model\StoreManagerInterface $storeManager
    ) {
    ...
    /*
     * check default category icon exist or not
     * @path : image dir path from media folder
     */

    public function defaultfileexist($path) {
